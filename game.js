...
var weapon1Json = boardEmptyCells[weapon1Position]; // On stocke le placement de l'arme 1 en JSON dans ces cases vides
  ...
  myGame.board[weapon1Json.emptyX][weapon1Json.emptyY] = "Couteau"; // On donne à la case le résultat 5 (pour signifier l'arme n°1 sur le plateau)
...
var weapon2Json = boardEmptyCells[weapon2Position]; // On stocke le placement de l'arme 2 en JSON dans ces cases vides
  ...
  myGame.board[weapon2Json.emptyX][weapon2Json.emptyY] = "Fourche"; // On donne à la case le résultat 6 (pour signifier l'arme n°2 sur le plateau)
...
var weapon3Json = boardEmptyCells[weapon3Position]; // On stocke le placement de l'arme 3 en JSON dans ces cases vides
  ...
  myGame.board[weapon3Json.emptyX][weapon3Json.emptyY] = "Flingue"; // On donne à la case le résultat 7 (pour signifier l'arme n°3 sur le plateau)
...
var weapon4Json = boardEmptyCells[weapon4Position]; // On stocke le placement de l'arme 2 en JSON dans ces cases vides
  ...
  myGame.board[weapon4Json.emptyX][weapon4Json.emptyY] = "Lance-flame"; // On donne à la case le résultat 6 (pour signifier l'arme n°2 sur le plateau)
